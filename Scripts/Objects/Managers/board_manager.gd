...
@export var slot_scene = preload ("res://objects/Slots/slot1.tscn")
@export var slotRusty = preload("res://objects/Slots/slotRusty.tscn")
@export var slotGolden = preload("res://objects/Slots/slotGolden.tscn")
@export var slotUpgrade = preload("res://objects/Slots/slotUpgrade.tscn")
